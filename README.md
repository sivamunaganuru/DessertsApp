...
- <img src="./assests/ListView.png" alt="ListView" width="250"/>: Illustrates the main list of dessert recipes.
- <img src="./assests/DetailedView.png" alt="DetailedView" width="250"/>: Displays the detailed information for a selected dessert.
- <img src="./assests/welcome.png" alt="Welcome Screen" width="250"/>: Serves as the introductory screen, welcoming users to the app.
